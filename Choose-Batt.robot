...
choisir un produit et l ajouter directement dans le panier + Voir le panier (2 produits)
                [Arguments]         ${Ajout_Panier_Batt}     ${Voir_panier}       ${Ajouter_nbr_produit}     ${Mettre_à_jour_panier}      ${Panier_mis_à_jour}      ${Valider_Commande}       ${Détails_de_facturation}
                  sleep       5
                  click element           ${Ajout_Panier_Batt}
                  sleep       5
