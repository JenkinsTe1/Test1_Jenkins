...
filtrer les produits by attribute
                            [Arguments]         ${Fabricant}       ${Couleur}       ${Taille-Dimension}
                            select from list by index       ${Fabricant3}       ${Fabricant}
                            sleep       7
                            select from list by index       ${Couleur3}         ${Couleur}
                            sleep       7
                            select from list by index       ${Taille_Dimension33}     ${Taille-Dimension}
                            sleep        7
                            click element                   ${Filtre_Button}
                            sleep       9
                            wait until element is visible   ${Produit_Access_33}